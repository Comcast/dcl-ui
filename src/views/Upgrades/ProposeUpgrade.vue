...
const isJsonAndHasRequiredFields = helpers.withMessage('JSON is not valid or missing required properties', (value) => {
    try {
            ...
            <form @submit.prevent="handleSubmit(!v$.$invalid)" class="">
                <div class="p-fluid">
                    <div class="p-grid mb-4">
                        ...
                        <div class="field">
                            <label for="upgradeInfo"
                                >Upgrade Info <span class="required mr-2">*</span>
