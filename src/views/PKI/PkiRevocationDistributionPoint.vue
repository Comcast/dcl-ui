      ...
      <div class="p-fluid">
        <form @submit.prevent="handleSubmit(!v$.$invalid)" class="">
          ...
          <div class="field">
            ...
            <Textarea v-model="v$.pkiRevocationDistributionPoint.crlSignerCertificate.$model"
              :class="{ 'p-invalid': v$.pkiRevocationDistributionPoint.crlSignerCertificate.$invalid && submitted }" style="display:block;width:100%" rows="10"    />
          </div>
