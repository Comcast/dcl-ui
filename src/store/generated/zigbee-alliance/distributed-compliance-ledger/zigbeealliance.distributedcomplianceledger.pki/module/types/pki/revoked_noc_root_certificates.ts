...
export const RevokedNocRootCertificates = {
  ...
  create<I extends Exact<DeepPartial<RevokedNocRootCertificates>, I>>(base?: I): RevokedNocRootCertificates {
    return RevokedNocRootCertificates.fromPartial(base ?? ({} as any));
  },
