...
function createBaseApprovedCertificates(): ApprovedCertificates {
  return { subject: "", subjectKeyId: "", certs: [], schemaVersion: 0 };
}

export const ApprovedCertificates = {
  encode(message: ApprovedCertificates, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.subject !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ApprovedCertificates {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseApprovedCertificates();
  ...
  create<I extends Exact<DeepPartial<ApprovedCertificates>, I>>(base?: I): ApprovedCertificates {
    return ApprovedCertificates.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ApprovedCertificates>, I>>(object: I): ApprovedCertificates {
    const message = createBaseApprovedCertificates();
