...
function createBaseRejectedCertificate(): RejectedCertificate {
  return { subject: "", subjectKeyId: "", certs: [], schemaVersion: 0 };
}

export const RejectedCertificate = {
  encode(message: RejectedCertificate, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.subject !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RejectedCertificate {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRejectedCertificate();
  ...
  create<I extends Exact<DeepPartial<RejectedCertificate>, I>>(base?: I): RejectedCertificate {
    return RejectedCertificate.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RejectedCertificate>, I>>(object: I): RejectedCertificate {
    const message = createBaseRejectedCertificate();
