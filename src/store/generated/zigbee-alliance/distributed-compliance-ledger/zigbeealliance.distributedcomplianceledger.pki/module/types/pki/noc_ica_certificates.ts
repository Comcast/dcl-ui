...
export const NocIcaCertificates = {
  encode(message: NocIcaCertificates, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.vid !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): NocIcaCertificates {
  ...
  create<I extends Exact<DeepPartial<NocIcaCertificates>, I>>(base?: I): NocIcaCertificates {
    return NocIcaCertificates.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<NocIcaCertificates>, I>>(object: I): NocIcaCertificates {
    const message = createBaseNocIcaCertificates();
