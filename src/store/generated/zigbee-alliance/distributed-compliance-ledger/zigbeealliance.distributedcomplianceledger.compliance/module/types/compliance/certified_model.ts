...
export const CertifiedModel = {
  encode(message: CertifiedModel, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.vid !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CertifiedModel {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCertifiedModel();
  ...
  create<I extends Exact<DeepPartial<CertifiedModel>, I>>(base?: I): CertifiedModel {
    return CertifiedModel.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CertifiedModel>, I>>(object: I): CertifiedModel {
    const message = createBaseCertifiedModel();
