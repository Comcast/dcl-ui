...
export class Api extends HttpClient {
     ...
     */
    queryDelegatorDelegations = (delegatorAddr, query, params = {}) => this.request({
     ...
     */
    queryRedelegations = (delegatorAddr, query, params = {}) => this.request({
   ...
   */
    queryDelegatorUnbondingDelegations = (delegatorAddr, query, params = {}) => this.request({
   ...
   */
    queryDelegatorValidators = (delegatorAddr, query, params = {}) => this.request({
   ...
   */
    queryDelegatorValidator = (delegatorAddr, validatorAddr, params = {}) => this.request({
     ...
     */
    queryHistoricalInfo = (height, params = {}) => this.request({
     ...
     */
    queryParams = (params = {}) => this.request({
     ...
     */
    queryValidators = (query, params = {}) => this.request({
     ...
     */
    queryValidator = (validatorAddr, params = {}) => this.request({
     ...
     */
    queryValidatorDelegations = (validatorAddr, query, params = {}) => this.request({
     ...
     */
    queryDelegation = (validatorAddr, delegatorAddr, params = {}) => this.request({
   ...
   */
    queryUnbondingDelegation = (validatorAddr, delegatorAddr, params = {}) => this.request({
     ...
     */
    queryValidatorUnbondingDelegations = (validatorAddr, query, params = {}) => this.request({
